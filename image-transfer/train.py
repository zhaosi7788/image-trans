        ...
        try:
            while not coord.should_stop():
                ...
                if step % 2000 == 0:
                    ...
                    self.save.save(self.sess, './model_saved_s/girl{}.ckpt'.format(step/2000))
                if step >= 40000:
                    break
...
parser.add_argument('-transfer_model', help='the path of transfer net model', type=str,
                    default='model_saved_s/scream16.0.ckpt') #  模型名称
parser.add_argument('-train_data_path', help='the path of train data', type=str,
                    default='train2014')
parser.add_argument('-style_data_path', help='the path of style image', type=str, default=os.getcwd() + '/img/girl.jpg')
